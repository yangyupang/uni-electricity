...
export default {
	...
	getNewAddress({addressId,checked,detailadress,openId,telNumber,userName}){
		return service.post(urlFormat("address/saveAction"),{addressId,checked,detailadress,openId,telNumber,userName})
	},
	// 获取全部地址
